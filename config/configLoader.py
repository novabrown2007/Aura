...
class ConfigLoader:
    ...
    def __init__(self, context=None, path: str | Path | None = None, devPath: str | Path | None = None):
        ...
        self.env_key_map = {
            ...
            "voice.wakeWord.wakeWordSensitivity": "WAKE_WORD_SENSITIVITY",
            "voice.wakeWord.wakeWordCooldownSeconds": "WAKE_WORD_COOLDOWN_SECONDS",
            "voice.wakeWord.wakeWordMicrophoneDevice": "WAKE_WORD_MICROPHONE_DEVICE",
            "voice.wakeWord.wakeWordModelPath": "WAKE_WORD_MODEL_PATH",
