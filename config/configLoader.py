...
DEFAULT_USER_CONFIG = {
    ...
    "spotify": {
        ...
        "cachePath": "spotify_cache.sqlite3",
        "api": {
            "clientId": "",
            ...
            "tokenCachePath": "spotify_auth.json",
            "autoAuthorize": False,
            "openBrowser": True,
            "accessToken": "",
            "refreshToken": "",
    ...
    "email": {
        ...
        "databasePath": "aura_email.sqlite3",
    },
    "safety": {
        "safetyLayerEnabled": True,
        "requireConfirmationForHighRisk": True,
        "allowAutomationWithoutConfirmation": False,
        "executionRateLimitEnabled": True,
...
CONFIG_ALIASES = {
    ...
    "personalScheduleEnabled": "personalSchedule.personalScheduleEnabled",
    "scheduleNotificationsEnabled": "personalSchedule.scheduleNotificationsEnabled",
    "allowRecurringSchedules": "personalSchedule.allowRecurringSchedules",
    "persistScheduleData": "personalSchedule.persistScheduleData",
    "scheduleTickIntervalSeconds": "personalSchedule.scheduleTickIntervalSeconds",
    "defaultReminderPriority": "personalSchedule.defaultReminderPriority",
    "weatherEnabled": "weather.weatherEnabled",
    "weatherApiEnabled": "weather.weatherApiEnabled",
    "localSensorWeatherEnabled": "weather.localSensorWeatherEnabled",
    "weatherAlertsEnabled": "weather.weatherAlertsEnabled",
    "weatherThresholdNotificationsEnabled": "weather.weatherThresholdNotificationsEnabled",
    "weatherForecastCacheEnabled": "weather.weatherForecastCacheEnabled",
    "weatherRefreshIntervalMinutes": "weather.weatherRefreshIntervalMinutes",
    "preferredWeatherProvider": "weather.preferredWeatherProvider",
    "spotifyEnabled": "spotify.spotifyEnabled",
    "spotifyPlaybackMonitoringEnabled": "spotify.spotifyPlaybackMonitoringEnabled",
    "spotifyOverlayEnabled": "spotify.spotifyOverlayEnabled",
    "spotifyCacheEnabled": "spotify.spotifyCacheEnabled",
    "spotifyReconnectEnabled": "spotify.spotifyReconnectEnabled",
    "spotifyPollingIntervalSeconds": "spotify.spotifyPollingIntervalSeconds",
    "defaultDevice": "spotify.defaultDevice",
    "spotifyCachePath": "spotify.cachePath",
    "spotifyClientId": "spotify.api.clientId",
    "spotifyRedirectUri": "spotify.api.redirectUri",
    "spotifyScopes": "spotify.api.scopes",
    "spotifyTokenCachePath": "spotify.api.tokenCachePath",
    "spotifyAutoAuthorize": "spotify.api.autoAuthorize",
    "spotifyOpenBrowser": "spotify.api.openBrowser",
    "spotifyAccessToken": "spotify.api.accessToken",
    "spotifyRefreshToken": "spotify.api.refreshToken",
    "spotifyExpiresAt": "spotify.api.expiresAt",
    "emailEnabled": "email.emailEnabled",
    "emailMonitoringEnabled": "email.emailMonitoringEnabled",
    "emailSyncIntervalSeconds": "email.emailSyncIntervalSeconds",
    "emailNotificationsEnabled": "email.emailNotificationsEnabled",
    "emailDefaultAccount": "email.emailDefaultAccount",
    "emailCacheEnabled": "email.emailCacheEnabled",
    "emailRequireConfirmationToSend": "email.emailRequireConfirmationToSend",
    "emailRequireConfirmationToDelete": "email.emailRequireConfirmationToDelete",
    "emailDatabasePath": "email.databasePath",
...
class ConfigLoader:
    ...
    def __init__(self, context=None, path: str | Path | None = None, devPath: str | Path | None = None):
        ...
        self.env_key_map = {
            ...
            "spotify.api.clientId": "SPOTIFY_CLIENT_ID",
            "spotify.clientId": "SPOTIFY_CLIENT_ID",
            "spotify.api.redirectUri": "SPOTIFY_REDIRECT_URI",
            ...
            "safetyLayerEnabled": "safety.safetyLayerEnabled",
            "requireConfirmationForHighRisk": "safety.requireConfirmationForHighRisk",
            "allowAutomationWithoutConfirmation": "safety.allowAutomationWithoutConfirmation",
            "executionRateLimitEnabled": "safety.executionRateLimitEnabled",
            "maxExecutionsPerMinute": "safety.maxExecutionsPerMinute",
            "auditLoggingEnabled": "safety.auditLoggingEnabled",
