...
class MySQLIntegrationTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        if not _env_true("RUN_LIVE_MYSQL_TEST"):
            self.skipTest("Set RUN_LIVE_MYSQL_TEST=true to run live MySQL integration testing.tests.")
    ...
    def _make_context(self):
        ...
        class Config:
            """Tiny config adapter exposing get/require methods for testing.tests."""
