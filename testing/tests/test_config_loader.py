...
class ConfigLoaderTests(unittest.TestCase):
    ...
    def test_missing_config_file_is_created_with_defaults(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.assertEqual(config.get("voice.alwaysActive.activationPhrases"), ["Aura", "Hey Aura", "Aura Wake"])
    ...
    def test_missing_config_files_are_created_separately(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.assertEqual(config.userData["voice"]["alwaysActive"]["activationPhrases"], ["Aura", "Hey Aura", "Aura Wake"])
